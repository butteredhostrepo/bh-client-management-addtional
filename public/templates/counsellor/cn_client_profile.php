    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="form-group col">
                ...
                <input type="text" class="form-control" id="mob_number" placeholder="Mobile Number" name="wpc_cf_phone_number" value="<?php echo get_user_meta($client_id, 'wpc_cf_phone_number', true); ?>">
                <div class="invalid-feedback">
                    Please provide mobile number
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col">
                ...
                <input type="text" class="form-control" id="address1" placeholder="Address 1" name="address_1" value="<?php echo   get_user_meta($client_id, 'address_1', true);
                                                                                                                        ?>">
            ...
            <div class="form-group col">
                ...
                <input type="text" class="form-control" id="address_2" placeholder="Address 2" name="address_2" value="<?php echo   get_user_meta($client_id, 'address_2', true);
                                                                                                                        ?>">
        ...
        <div class="row">
            ...
            <div class="form-group col">
                ...
                <input type="text" class="form-control" id="town" placeholder="Town" name="town" value="<?php echo  get_user_meta($client_id, 'town', true);
                                                                                                        ?>">
            ...
            <div class="form-group col">
                ...
                <input type="text" class="form-control" id="post_code" placeholder="Post Code" name="post_code" value="<?php echo get_user_meta($client_id, 'post_code', true);
                                                                                                                        ?>">
        ...
        <div class="row">
            ...
            <div class="form-group col">
                ...
                <input type="email" class="form-control" id="kin_email" placeholder="Name of kin" name="kin_email" value="<?php echo  isset($_GET['kin_email']) ? $_GET['kin_email'] :  get_user_meta($client_id, 'kin_email', true);
                                                                                                                            ?>">
                <div class="invalid-feedback">
        ...
        <div class="row">
            ...
            <div class="form-group col">
                ...
                <input type="text" class="form-control" id="kin_phone" placeholder="Number of kin" name="kin_phone" value="<?php echo  isset($_GET['kin_phone']) ? $_GET['kin_phone'] :  get_user_meta($client_id, 'kin_phone', true);
                                                                                                                            ?>">
        ...
        <div class="row">
            ...
            <div class="form-group col">
                ...
                <input type="email" class="form-control" id="gp_email" placeholder="Name of gp" name="gp_email" value="<?php echo  isset($_GET['gp_email']) ? $_GET['gp_email'] :  get_user_meta($client_id, 'gp_email', true);
                                                                                                                        ?>">
                <div class="invalid-feedback">
                    Please provide valid email
                </div>
        ...
        <div class="row">
            ...
            <div class="form-group col">
                ...
                <input type="text" class="form-control" id="gp_phone" placeholder="Number of gp" name="gp_phone" value="<?php echo  isset($_GET['gp_phone']) ? $_GET['gp_phone'] :  get_user_meta($client_id, 'gp_phone', true);
                                                                                                                        ?>">
        ...
        <div class="float-right">
            <a href="/counsellor/clients/" class="btn btn-sharp-edge  btn-outline-secondary mr-2">Back to Clients</a>
